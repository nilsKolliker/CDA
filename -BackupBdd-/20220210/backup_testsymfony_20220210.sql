...
--
-- Host: localhost    Database: testsymfony
-- ------------------------------------------------------
...
--
-- Current Database: `testsymfony`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `testsymfony` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
INSERT INTO `job` VALUES (1,'job1',35),(2,'job2',12);
