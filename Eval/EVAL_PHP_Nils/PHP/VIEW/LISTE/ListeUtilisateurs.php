...
echo '<div class="caseListe grid-columns-span-6">Liste des Utilisateurs </div>';
...
echo '<div class="caseListe entete">Nom</div>';
echo '<div class="caseListe entete">Prenom</div>';
echo '<div class="caseListe entete">AdresseMail</div>';
