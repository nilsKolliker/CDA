 ...
 * @return void
 */
function creerSelect(?int $valeur, string $table, array $nomColonnes, string $attributs = "", array $condition = null, string $orderBy = null, $api = false, $enTete="Choisir une valeur")
{
		...
		if ($valeur == null) {
				$select .= '<option value="" SELECTED>'.$enTete.'</option>';
		} else {
				$select .= '<option value="">'.$enTete.'</option>';
		}
